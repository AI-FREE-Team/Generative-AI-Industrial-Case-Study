...
## 1. 前言
隨著人工智慧（AI）的演進，生成式AI工具已經開始改變我們與電腦互動的方式。他們不再只是冰冷的程式碼，
更像是創作夥伴，能夠協助我們的創意發想，讓我們的思考更周全。這個單元，我們將從文字到圖像再到語音，一步步介紹這些改變人類生活方式的生成式AI工具。
...
## 3. 圖像類型的生成式 AI 工具
這類型的生成式AI工具輸出的資料型態不是影像就是動畫，目前網路上知名的工具包含：Stable Diffusion、Image Creator、Midjourney、Runway、Pika Labs，除了 Midjourney 需要先付費訂閱才能試用之外，其它工具多半是開源免費，或是提供限量的試用 token，一樣也邀請讀者們點擊下方圖片欄，實際體驗幾秒鐘之內生成影像！
...
## 4. 音訊類型的生成式 AI 工具
目前這類型的生成式AI工具雖然沒有像是文字類型或是影像類型的生成式AI工具如此佔據社群媒體的版面，主要原因是因為其技術尚且在發展以及普及，接觸者多數還是屬於軟體工程背景的機構與對象，不過隨著生成式AI的快速發展，在近年之內，應當會有更多的生成式AI工具出現，將會是一般民眾、非資訊產業業者能夠迅速上手的工具，以下我們附上知名科技公司提供相關音訊服務資訊。
